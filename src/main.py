...
def main(filename):
    try:
        ...
        if 'mainSettings' in qf and 'semanticNeeded' in qf['mainSettings'] and qf['mainSettings']['semanticNeeded'] == True:
        ...
        if 'mainSettings' in qf and 'styleNeeded' in qf['mainSettings'] and qf['mainSettings']['styleNeeded'] == True:
